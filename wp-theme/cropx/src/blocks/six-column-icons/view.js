...
/*
 * Six-Column Icons — front-end controller.
 *
 ...
 * reveal animation (eyebrow/heading/items fading up as the section scrolls
 ...
 * set.
 */
initScrollReveal( '.wp-block-cropx-six-column-icons' );
