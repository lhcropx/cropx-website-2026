...
/*
 * Three-Column Icons — front-end controller.
 *
 ...
 * reveal animation (eyebrow/heading/grid items fading up as the section
 ...
 * set.
 */
initScrollReveal( '.wp-block-cropx-three-column-icons' );
