...
/*
 * Job Openings — front-end controller.
 *
 ...
 * reveal animation (heading/job list fading up as the section scrolls into
 * view) via the shared initScrollReveal() helper. See
 ...
 * set.
 */
initScrollReveal( '.wp-block-cropx-job-openings' );
