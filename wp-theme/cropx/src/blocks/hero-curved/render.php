...
if ( $device_id ) {
	...
	$device_markup = '<img class="hc-device" src="' . esc_url( $device_url ) . '" alt="' . esc_attr__( 'CropX soil sensor', 'cropx' ) . '"' . cropx_img_dims_attr( 0, $device_url ) . ' loading="eager">';
} else {
	...
	$device_markup .= '<img class="hc-device" src="' . esc_url( $theme_uri . 'assets/images/illustrations/vertex-partial-a.png' ) . '" alt="' . esc_attr__( 'CropX soil sensor', 'cropx' ) . '" width="465" height="1400" loading="eager">';
	$device_markup .= '</picture>';
}
...
if ( $phone_id ) {
	...
	$phone_markup = '<img class="hc-phone" src="' . esc_url( $phone_url ) . '" alt="' . esc_attr__( 'CropX app on iPhone', 'cropx' ) . '"' . cropx_img_dims_attr( 0, $phone_url ) . ' loading="eager">';
} else {
	...
	$phone_markup .= '<img class="hc-phone" src="' . esc_url( $theme_uri . 'assets/images/illustrations/phone-mockup-b.png' ) . '" alt="' . esc_attr__( 'CropX app on iPhone', 'cropx' ) . '" width="800" height="998" loading="eager">';
	$phone_markup .= '</picture>';
}
