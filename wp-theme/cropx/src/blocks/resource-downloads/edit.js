			...
			<InspectorControls>
				...
				<PanelBody title={ __( 'Layout', 'cropx' ) } initialOpen={ false }>
					...
					<SelectControl
						...
						help={ __( 'Aligns the eyebrow, heading, and body text above the grid.', 'cropx' ) }
					...
					<SelectControl
						...
						help={ __( 'Only visible when there are fewer resources than columns — a full row always fills the width either way.', 'cropx' ) }
