...
$wrapper_attrs = get_block_wrapper_attributes( [ 'class' => 'pg-block' ] );
?>
<section <?php echo $wrapper_attrs; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
	<div class="pg-inner">
		...
		<header class="pg-header">
			<?php if ( $eyebrow ) : ?>
				<span class="pg-eyebrow" style="color: var(--<?php echo $eyebrow_color; ?>)">
					<?php echo esc_html( $eyebrow ); ?>
				</span>
			<?php endif; ?>
			<?php if ( $heading ) : ?>
				<h2 class="pg-heading"><?php echo esc_html( $heading ); ?></h2>
			<?php endif; ?>
			<?php if ( $blurb ) : ?>
