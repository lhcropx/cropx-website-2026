 ...
 *
 * Default template: case studies and any untagged customer stories. Posts
 * tagged "Video Testimonial" are swapped onto a separate, simpler template
 * (single-cropx_publication-video-testimonial.php) by the template_include
 * filter in inc/customer-stories.php — that variant drops the right-hand
 * share sidebar, the Key Findings card, the Download CTA, and the case-study
 * "At a Glance" fields, none of which apply to a video testimonial. White
 * Paper moved to the cropx_resource CPT — see inc/cpts.php.
